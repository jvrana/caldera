...
def test_check_back_prop_layer_norm(layer_norm):
    """Backpropogation should work through the layer normalization layer (only
    if elementwise_affine is false however...)"""
...
@pytest.mark.parametrize(
    "layer_norm", [True, False], ids=lambda x: "layer_norm={}".format(x)
)
